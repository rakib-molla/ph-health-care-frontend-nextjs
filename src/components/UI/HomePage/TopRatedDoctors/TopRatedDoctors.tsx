...
const TopRatedDoctors = async()=>{
  ...
  return (
    <Box sx={{
        ...
        <Typography variant="h4" fontWeight={700}> Our Top Rated Doctor</Typography>
        ...
        <Typography component="p" fontWeight={400} fontSize={18}>and top-quality surgery facilities right here.</Typography>
        </Box>
            ...
            <Grid container spacing={2}>
                {doctors.map((doctor: any)=>(
                    <Grid item key={doctor.id} md={4}>
                        <Card >
      <Box>
        <Image src={doctor.profilePhoto} width={500} height={500} alt="doctor"/>
      </Box>
      <CardContent>
